 ...
 *
 * Варіант 30: 3 імені, по 3 склади
 */
...
// Обробка форми (твій варіант)
$syllablesInput = $_POST['syllables'] ?? 'пар ло ні гу зе тір ма ков ша бі';
$count = (int)($_POST['count'] ?? 3); // <-- було 4
$syllablesPerName = (int)($_POST['syllables_per_name'] ?? 3); // <-- було 2
